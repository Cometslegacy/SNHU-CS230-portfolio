...
public class GameAuthApplication extends Application<Configuration> {
	...
	public void run(Configuration c, Environment e) throws Exception 
	{
	    ...
	    // Create JerseyClientBuilder instance and give it Environment reference
	    JerseyClientBuilder jerseyClientBuilder = new JerseyClientBuilder(e);

	    // Create the Client named "DemoRESTClient"
	    Client client = jerseyClientBuilder.build("DemoRESTClient");
